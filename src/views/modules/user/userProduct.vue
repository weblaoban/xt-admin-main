...
"
    ...
    <el-input v-model="userForm.userMail"></el-input>
                ...
                <el-col :span="12">  <el-form-item label="认购金额" prop="amount">
...
<div class="tablecon" style="max-height:300px;overflow-y:scroll;width:100%;">
    <el-table
      :data="detailItem.userDtm"
      style="width: 100%">
      <el-table-column
        label="序号">
        <template slot-scope="scope">
        <span style="margin-left: 10px">{{ scope.$index
            +1 }}</span>
      </template>
      </el-table-column>
      <el-table-column
    ...
    getDataDetail (id) {
      this.$http({
        url: this.$http.adornUrl(
						`/admin/prodTagReference/info/${id}`
					),
        method: 'get',
        params: this.$http.adornParams()
      }).then(({ data }) => {
