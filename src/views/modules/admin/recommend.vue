...
<el-button type="primary" v-if="scope.index>0 && scope.row.id" icon="el-icon-top" @click="goUp(scope.row,scope.index,dataList)"></el-button>
		...
		>
			...
			<template slot-scope="scope" slot="menu">
                <!-- 上衣 -->
<el-button type="primary" v-if="scope.index>0 && scope.row.id" icon="el-icon-top" @click="goUp(scope.row,scope.index,dataList2)"></el-button>
                <!-- 下衣 -->
                <el-button v-if="scope.index<(dataList2.length-1) && scope.row.id" type="primary" icon="el-icon-bottom" @click="goDown(scope.row,scope.index,dataList2)"></el-button>
		...
		>
			...
			<template slot-scope="scope" slot="menu">
                <!-- 上衣 -->
<el-button type="primary" v-if="scope.index>0 && scope.row.id" icon="el-icon-top" @click="goUp(scope.row,scope.index,dataList3)"></el-button>
                <!-- 下衣 -->
                <el-button v-if="scope.index<(dataList3.length-1) && scope.row.id" type="primary" icon="el-icon-bottom" @click="goDown(scope.row,scope.index,dataList3)"></el-button>
